  ...
  return (
    <Layout>
      <div className="container mx-auto px-4 py-12 relative">
        <div className="absolute -z-10 top-16 left-8 w-64 h-64 bg-primary-300/30 rounded-full blur-3xl animate-float" />
        <div className="absolute -z-10 bottom-16 right-8 w-48 h-48 bg-primary-200/40 rounded-full blur-3xl animate-float" style={{ animationDelay: '2s' }} />
        <div className={`max-w-md mx-auto card transform transition-all duration-700 ${mounted ? 'opacity-100 translate-y-0 scale-100' : 'opacity-0 translate-y-10 scale-95'}`}>
          <div className="text-center mb-6">
            ...
            <h1 className="text-4xl font-extrabold bg-gradient-to-r from-primary-700 to-primary-900 bg-clip-text text-transparent">Register</h1>
          </div>
